...
@Entity
@Table(name="stats_round_player_stats")
@IdClass(StatsRoundPlayerStatsPK.class)
@Cacheable(false)
public class StatsRoundPlayerStats implements Serializable {
	...
	public String toString() {
		return "StatsRoundPlayerStats [round=" + round + ", name=" + name + ", team=" + team + ", jumperNo=" + jumperNo
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StatsRoundPlayerStats other = (StatsRoundPlayerStats) obj;
